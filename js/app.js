...
$(document).ready(function(){   
    ...
    //春节倒计时
    var starttime = new Date("2021/12/25");
    setInterval(function () {
        ...
        $('.time').html("<p>圣诞节倒计时</p>" + "<p><span>" + day + "</span>" + "天</p>");
        $(".sydate").html(syday);
    ...
    var mess = "<span>哈喽啊, 少年！！</span><span class='B-span2'>祝你，圣诞快乐！</span><span>Hello,Merry Christmas！</span>";
    $(".Barrage").append(mess);
    ...
    var this_url=window.location.href;
        ...
        wx.ready(function () {   //需在用户可能点击分享按钮前就先调用
            ...
            wx.updateAppMessageShareData({ 
                ...
                desc: '你好, 2021, 新年快乐！ 春节倒计时, 一大波弹幕正在来袭！！', // 分享描述
